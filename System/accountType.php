...
<head>
  ...
  <link rel="stylesheet" href="assets/css/components.css">
   ...
   <script>
    function myFunction() {
      var x = document.getElementById("accountType");
...
<body>
              ...
              <div class="card">
                <div class="card-header">
                  ...
                  <div class="card-header-action">
                    <button   data-toggle="modal" data-target="#logoutModal" class="dropdown-item has-icon text-danger btn btn-primary" style="color: white !important;" class="btn btn-primary">Add Account Type</button>
                  </div>
                </div>
                  ...
                  <div class="table-responsive" id="result">
                    <table id="example" class="table table-striped table-bordered mb-0" style="width:100%; padding:10px !important;">
                      ...
                      <tbody>
                        ...
                        $result = $accountType->getAllAccountTypes();
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Adding Account Type </h5>
              ...
              <div class="modal-body">
                     ...
                     <form id="accountType">
                        <div class="form-group col-md-12 col-lg-12">
                         ...
                         <button type="button" style="color: white;" id="add_accounttype"   class="btn btn-primary daterange-btn icon-left btn-icon"><i class="fas fa-calendar"></i> Save
                          </button> 
                    </form>
            </div>
            </div>
 ...
 <script type = "text/javascript">
  ...
  /*  ADDING POST */  
    ...
    $('#add_accounttype').on('click', function(){
      if($('#name').val() == ""){
